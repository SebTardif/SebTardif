...
<!-- RECENT-PRS-START -->
- [ci: replace dependency-review deny-licenses with an allowlist](https://github.com/coolify-terraform/terraform-provider-coolify/pull/793) in **coolify-terraform/terraform-provider-coolify**

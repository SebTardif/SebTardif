...
<!-- RECENT-PRS-START -->
- [docs: add Coolify version support matrix guide](https://github.com/coolify-terraform/terraform-provider-coolify/pull/688) in **coolify-terraform/terraform-provider-coolify**

...
<!-- RECENT-PRS-START -->
- [feat: pin Coolify API contract to v4.3.5](https://github.com/coolify-terraform/terraform-provider-coolify/pull/779) in **coolify-terraform/terraform-provider-coolify**
- [fix(cli): doctor optional deps, init next step, and check --timeout](https://github.com/assura-lang/assura/pull/1504) in **assura-lang/assura**
